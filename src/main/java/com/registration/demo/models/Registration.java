...
public class Registration
{
	...
	public Registration(int id, String first_name, String second_name, String adress_1, String adress_2, String city,
			String state, String pincode, String proffesion, String email, String mobilenumber, Date date,
